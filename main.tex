...
\cventry{Republic of Korea Army}{Seongnam, Gyeonggi, Korea}
{Military Software Engineer (Corporal)}{Mar. 2023 - Present}
{
    \item Performing full-stack web development tasks, mostly using django and react.js.
    \item Mandatory military service required to all male Korean citizens. (Expected date of discharge: Sep. 2024)
}
...
{Undergraduate Research Intern}{Jun. 2022 - Aug. 2022}
{
    ...
    \item Studied methods for detecting and correcting motion artifact of magnetic resonance(MR) images
}
\begin{comment}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cvsection{Skills}
\cvline{Programming}{Python, C++, JavaScript, Rust}
\cvline{Tools}{Git, \LaTeX{}}
\cvline{Frameworks}{PyTorch, Django, React, Hugging Face}
\vspace{2mm}
