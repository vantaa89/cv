...
\cvlist{
    ...
    \item Digital Logic Design, Introduction to Electromagnetism,  Signals \& Systems, Introduction to Circuit Theory
    % \item Deep Learning(\textit{graduate}), Scalable High-Performance Programming(\textit{graduate}), Computer Systems Programming, Computer Organization
