...
{Undergraduate Student}{Mar. 2021 - Present}
{
    ...
    \item GPA: 4.24/4.3
    \item Mar. 2023 - Sep. 2024: Leave of absence due to mandatory military service
}
...
{Undergraduate Research Intern (Advisor: Jonghyun Choi)}{Sep. 2024 - Present}
{
    \item
}
...
\cvlist{
    ...
    \item Compuer Organization, Systems Programming, Scalable High-Performance Computing (\textit{graduate}), Logic Design
    \item Intro. to Electromagnetism,  Signals \& Systems, Intro. to Circuit Theory, Foundation of Control Engineering
