...
\cvlist{
    ...
    \item Computer Organization, Scalable High-Performance Computing (\textit{graduate}), Systems Programming, Logic Design
    \item Introduction to Electromagnetism,  Signals and Systems, Circuit Theory, Control Engineering
